...
module Agents
  class GoogleCalendarPublishAgent < Agent
    ...
    description <<-MD
      The GoogleCalendarPublishBot creates events on your google calendar.

      This robots relies on service accounts, rather than oauth.

      Setup:

      1. Visit [the google api console](https://code.google.com/apis/console/b/0/)
      2. New project -> NewsUK Alerts
      ...
      `google` A hash of configuration options for the robot.
      ...
      Use it with a trigger robot to shape your payload!
      ...
      Example payload for trigger robot:
      <pre><code>{
        "message": {
          "visibility": "default",
