...
module Agents
  class UserLocationAgent < Agent
    ...
    description do
      <<-MD
        The UserLocationBot creates events based on WebHook POSTS that contain a `latitude` and `longitude`.  You can use the POSTLocation iOS app to post your location.
