module Agents
  class DataOutputAgent < Agent
    ...
    description  do
      <<-MD
        The Robot outputs received events as either RSS or JSON.  Use it to output a public or private stream of Huginn data.

        This Robot will output data at:
        ...
        Options:
          ...
          * `expected_receive_period_in_days` - How often you expect data to be received by this Robot from other Robots.
    ...
    def default_options
      {
        ...
        "template" => {
          ...
          "description" => "This is a feed of recent XKCD comics, generated by NewsUK Alerts",
          "item" => {
            "title" => "{{title}}",
    ...
    def validate_options
      ...
      unless options['expected_receive_period_in_days'].present? && options['expected_receive_period_in_days'].to_i > 0
        errors.add(:base, "Please provide 'expected_receive_period_in_days' to indicate how many days can pass before this Robot is considered to be not working")
      end
    ...
    def feed_description
      interpolated['template']['description'].presence || "A feed of Events received by the '#{name}' Robot"
    end
